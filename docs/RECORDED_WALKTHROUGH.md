...
Learn to read source scope, choose a callable for closer inspection, and interpret
duplication alongside its coverage. Open the [recorded Story](https://metrolith.dev/demo)
and follow its links into Explorer.

This is recorded hosted evidence, not a fresh run with the latest published CLI,
a benchmark or a proven defect assessment. The CLI's `metrolith report` creates a
separate offline HTML report. [Identity and provenance](#know-which-evidence-you-are-reading)
remain available below, including the original 3.8.0 producer and later evaluator.

## 1. Count the population before interpreting its size

**Question:** What source population do these totals describe?
...
**Question:** Which callable should I inspect next, and what does its value mean?
...
**Question:** Where is repetition recorded, and how complete is that evidence?
...
Check the measured population, follow callable source pointers, and keep each
duplication population beside its coverage. These observations guide inspection;
they do not establish architecture quality or prove defects.
